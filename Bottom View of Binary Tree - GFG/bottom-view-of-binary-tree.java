...
//unlike the Top View of Binary Tree, we don't need an if loop, as we want to update the HashMap as much as possible, thereby reaching the bottom of binary tree.
      //do something.
            ...
            if(currNode.right != null)
                q.add(new Pair(currNode.right, hdis+1));
